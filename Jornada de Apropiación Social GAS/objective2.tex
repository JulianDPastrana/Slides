...
\begin{columns}[T,onlytextwidth] 
	...
	\begin{itemize}
		\item Injection at node $w$: 
		\begin{itemize}
			\item $f_{\text{iny}}^w$ – injected flow
			\item $C_{\text{iny}}^w$ – injection cost
		\end{itemize}
		
		\item Pipeline $p$: 
		\begin{itemize}
			\item $f_{\text{trans}}^p$ – transported flow
			\item $C_{\text{trans}}^p$ – transport cost
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		\item Compressor $c$: 
		\begin{itemize}
			\item $f_{\text{trans}}^c$ – transported flow
			\item $C_{\text{trans}}^c$ – transport cost
		\end{itemize}
		
		\item Unmet demand for user $u$ at node $i$:
		\begin{itemize}
			\item $f_{\text{rest}}^{u,i}$ – unmet demand flow
			\item $C_{\text{rest}}^{u,i}$ – penalty cost
		\end{itemize}
	\end{itemize}
