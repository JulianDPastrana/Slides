...
The dimensionality \(P_t\)​ at each time step varies depending on which signals are present at that particular instant due to their individual sampling rates, as despice in \cref{fig:input_space_structure}.
