\section[\empty]{Objective 3: }

\begin{frame}{Objetive 3: Irregular Multimodal Dataset Integration}
	\begin{columns}[c] % [c] = vertically center
		
		% Left column
		\begin{column}{0.48\textwidth}
			\centering
			\scalebox{0.7}{\input{figures/transformer_encoder.tex}}
		\end{column}
		
		% Right column
		\begin{column}{0.48\textwidth}
			\centering
			\scalebox{0.7}{\input{figures/maskz.tex}}
		\end{column}
