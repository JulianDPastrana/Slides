...
\begin{frame}{Problem Statement}
    ...
    Foundation models take advantage of large-scale self-supervised pretraining, enabling strong generalization, zero-shot inference, and multimodal integration capabilities.
